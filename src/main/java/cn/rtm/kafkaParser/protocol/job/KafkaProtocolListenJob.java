package cn.rtm.kafkaParser.protocol.job;


import cn.rtm.kafkaParser.protocol.ProtocolHandler;
...
public class KafkaProtocolListenJob implements ApplicationRunner {
    ...
    @Resource
    private ProtocolHandler kafkaProtocolHandler;
...
//                .build();
    ...
    private void parsePacket(Packet packet) {
        kafkaProtocolHandler.handle(packet);
    }
